                ...
                <div class="c-content-popup">
                    ...
                    <div class="c-content-beer">
                        <div class="c-img-beer">
                            <div class="img-beer"></div>
                        </div>
                        <div class="c-info-beer">
                            <div class="c-title-beer">
                                <h1>Maze Bloody Maze</h1>
                            </div>
                            <h2>Imperial Porter</h2>
                            <h3>8,2% vol.</h3>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum libero, dignissimos consequatur exercitationem cum magnam. Dolor debitis itaque dolorem cum, harum suscipit amet aut beatae voluptas rem. Iste dolor in minus, ex doloribus minima ipsum temporibus natus ullam facilis maiores labore aliquid ab repellat. Iusto nam nemo deleniti dicta quia, corrupti quasi impedit id delectus laborum cupiditate alias voluptatum consequuntur!</p>
                        </div>
                    </div>
                </div>
            </div>
